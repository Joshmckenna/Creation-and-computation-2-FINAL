...
#define MAX_BRIGHTNESS 164      // Full power = 164
#define MIN_BRIGHTNESS 32       // Minimum set to 25% of max
...
const int brightnessInPin = A0;  // The Analog input pin that the potentiometer is attached to.
...
int notes [] = {NOTE_A3, NOTE_C4, NOTE_D4, NOTE_E4, NOTE_G4, NOTE_A4, NOTE_C5, NOTE_D5, NOTE_E5, NOTE_G5};

#define echoPin 7
#define trigPin 8
//#define LEDPin 13  // No longer needed as indicator
#define speakerOut 9
...
void setup() {
  // ** ** ** LEDS ** ** ** //
  delay(3000); // To prevent locking out while prototyping code.
...
void loop() {
  ...
  tone(speakerOut, notes[map(distance,0,60,0,9)], noteDuration);
